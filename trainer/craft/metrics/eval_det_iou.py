...
class DetectionIoUEvaluator(object):
    ...
    def evaluate_image(self, gt, pred):
        ...
        def get_intersection(pD, pG):
            polyD = Polygon(pD)
            polyG = Polygon(pG)
            if polyD.intersects(polyG):
                return polyD.intersection(polyG).area
            return 0
        ...
        def get_intersection_over_union(pD, pG):
            ...
            polyG = Polygon(pG)
            if polyD.intersects(polyG):
                intersection = polyD.intersection(polyG).area
                union = polyD.union(polyG).area
        ...
        #     polyG = Polygon(pG)
        #     if polyD.intersects(polyG):
        #         intersection = polyD.intersection(polyG)
