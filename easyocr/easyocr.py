...
class Reader(object):
    def __init__(
        ...
        if recog_network in ["standard"] + [
            ...
            self.setModelLanguage(
                recog_network, lang_list, available_lang, str(available_lang)
            )
